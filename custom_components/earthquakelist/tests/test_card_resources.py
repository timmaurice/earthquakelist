...
NEW_URL = f"{CARD_URL_BASE}/earthquakelist-card.js?v=1.3.0"
OLD_URL = f"{CARD_URL_BASE}/earthquakelist-card.js?v=1.2.0"
        ...
        [
            {
                "id": "existing",
                "res_type": "module",
                "url": f"{CARD_URL_BASE}/earthquakelist-card.js?v=1.2.0",
            }
        ]
    )
        ...
        [
            {
                "id": "one",
                "res_type": "module",
                "url": f"{CARD_URL_BASE}/earthquakelist-card.js?v=1.0.0",
            },
            {
                "id": "two",
                "res_type": "module",
                "url": f"{CARD_URL_BASE}/earthquakelist-card.js?v=1.1.0",
            },
            {
                "id": "three",
                "res_type": "module",
...
async def test_loads_a_store_that_does_not_expose_the_loaded_flag() -> None:
